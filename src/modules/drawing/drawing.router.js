...
router.get('/',auth(),asyncHandler(drawingController.getAllDrawings));//disaply child drawings results + pageination +sort
router.get('/:childId',auth(),asyncHandler(drawingController.getAllChildDrawings));
